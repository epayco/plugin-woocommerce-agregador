...
class WC_Agregador_Epayco extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		if ( ! empty( $logo_url ) ) {
			...
			$this->icon = apply_filters( 'woocommerce_' . $this->id . '_icon', EPAYCO_AGREGADOR_PLUGIN_URL . 'assets/images/epayco1.png' );
		}
        $this->method_title         = __( 'ePayco Checkout', 'woo-epayco-agregador' );
        $this->method_description   = __( 'Acepta tarjetas de credito, depositos y transferencias.', 'woo-epayco-agregador' );
	...
	function init_form_fields() {
		$this->form_fields = array(
			...
			'title'            => array(
				...
				'default'     => __( 'Checkout ePayco (Tarjetas de crédito,debito,efectivo)', 'woo-epayco-agregador' ),
				'desc_tip'    => true,
			),
			'description'      => array(
				...
				'default'     => __( 'Checkout ePayco (Tarjetas de crédito,débito,efectivo)', 'woo-epayco-agregador' ),
			),
	...
	function receipt_page( $order_id ) {
        echo ' <div class="loader-container">
                ...
                <p style="text-align: center;" class="epayco-title">
                    <span class="animated-points">' . esc_html__( 'Loading payment methods', 'woo-epayco-agregador' ) . '</span>
                    <br><small class="epayco-subtitle"> ' . esc_html__( 'If they do not load automatically, click on the "Pay with ePayco" button', 'woo-epayco-agregador' ) . '</small>
                </p>';
            ...
            switch ($x_cod_transaction_state) {
                case 1: {
                    ...
                    if($current_state == "epayco_agregador_failed" ||
                        ...
                        if($current_state == "epayco_agregador_processing" ||
