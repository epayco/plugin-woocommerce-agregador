...
if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            $(".validar").on("click", function() {
                                                ...
                                                const epayco_publickey = $("#woocommerce_epayco_agregador_epayco_agregador_publickey")[0].defaultValue.trim();
                                                const epayco_privatey = $("#woocommerce_epayco_agregador_epayco_agregador_privatekey")[0].defaultValue.trim();
                                                const epayco_secretkey = $("#woocommerce_epayco_agregador_epayco_agregador_secretkey")[0].defaultValue.trim();
                                                if (epayco_publickey !== "" && 
                                                    epayco_privatey !== "" &&
                                                    epayco_secretkey !== "") {
    ...
    function epayco_agregador_update_db_check()
    {
        ...
        if ($installed_ver == null || $installed_ver != $epayco_agregador_db_version) {
            ...
            update_option('epayco_agregador_db_version', $epayco_db_version);
        }
    }
