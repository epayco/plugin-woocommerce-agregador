...
class EpaycoagregadorOrder{
	...
	public static function create($orderId, $stock)
	{
		...
		global $wpdb;
		$table_name = $wpdb->prefix . "epaycoagregador_order";
	...
	public static function setup()
	{
	    ...
	    add_option('epaycoagregador_db_version', $epaycoagregador_db_version);
	}
	...
	public static function remove(){
		$sql = array(
				'DROP TABLE IF EXISTS '._DB_PREFIX_.'epaycoagregador_order'
		);
